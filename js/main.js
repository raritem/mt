...
async function loadCatalogue() {
  ...
  try {
    ...
    const [data, tanksDataRaw, nationIndex, tierIndex, typeIndex, tanksIndex, accountsIndex] = await Promise.all([
      rawBase
      ...
      rawBase
        ? fetchJSON(rawBase + 'data/indexes/accounts_index.json').catch(() => ({}))
        : fetchJSON(ROOT + 'data/indexes/accounts_index.json').catch(() => ({})),
    ]);
