...
function bindFadeCleanup() {
  ...
  document.addEventListener('animationend', (e) => {
    ...
    // Фиксируем финальное состояние инлайном
    el.style.opacity = '1';
    el.style.transform = 'translateY(0)';
    // Снимаем класс и анимацию — инлайн-стили удерживают позицию
    el.classList.remove('fade-up');
    el.style.animationDelay = '';
    el.style.willChange = '';
    el.style.animation = '';
    // Инлайн opacity/transform НЕ сбрасываем — они безвредны (1 и 0),
    // а сброс в rAF создавал однокадровый провал: браузер на миг
    // переприменял fade-prep (translateY 16px) → видимый скачок вниз-вверх.
  }, true);
}
